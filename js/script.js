...
let cardillu = document.getElementById ("cardillu");
...
let txtcardillu = document.getElementById ("txtcardillu");
...
let tltcardillu = document.getElementById ("tltcardillu");
...
cardillu.addEventListener("mouseover", function animecard10 () {
  tltcardillu.style.top ="-20px";
  txtcardillu.style.top ="35px";
  cardillu.addEventListener("mouseout", function animecard11 () {
    tltcardillu.style.top ="40px";
    txtcardillu.style.top ="120px";
  })
});
